...
console.conf.consoleMarginTop = 2 -- Top border margin of the console text.
...
console.conf.sizeMin = 3 -- Minimum lines the console should display before extending to the max size.
